insert into Persona values (1,"Camilo Romero","M", "1993/12/31", null, null, "preso");
insert into Persona values (2,"Tatiana Serna","F", "1999/11/12", null, null, "preso");
insert into Persona values (2,"Tatiana Serna","F", "1999/11/12", null, null, "guardian");
insert into celda values (1,"10x9x8","M",4);
insert into condena values (1, "2020/10/31" , 10, "2020/12/31", "2030/12/31" ,41,3);
insert into condena values (2, "2020/10/31" , 10, "2020/12/31", "2030/12/31" ,41,4);
